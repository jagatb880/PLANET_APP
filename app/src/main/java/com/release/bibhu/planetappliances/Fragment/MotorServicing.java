...
public class MotorServicing extends Fragment implements ConnectivityInterface.ApiInterafce {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.motor_servicing, container, false);
